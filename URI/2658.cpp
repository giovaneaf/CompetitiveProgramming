/*
In this problem can be used a Segment Tree with Lazy Propagation the difference is that the update is a rotation of
the frequency array and to get the most frequent inside the interval you can only check it linearly (Only 9).
*/
