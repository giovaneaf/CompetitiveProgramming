/*
Just use Segment Tree with Lazy Propagation because it's needed to update intervals and
not only one value in the array. You can do queries and updates in O(log(n)).
*/
