/*
	...
	Simplex Algorithm from:https://github.com/splucs/Competitive-Programming/blob/master/Macac%C3%A1rio/Miscelaneous/simplex.cpp
	
	Used to solve problem Keep Him Inside (K) - BAPC 2019
