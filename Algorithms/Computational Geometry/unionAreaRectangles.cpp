/*
	Finding area union of rectangles with segment tree in O(n*log(n)) 
	where n is the number of rectangles.
	
	Used to solve problem Gluttonous Goop (G) - BAPC 2019
...
#define fst first
#define snd second
#define MAXN 410		// set maximum number of rectangles
...
int main()
{
	...
	while(cin >> n >> m >> k)
	{
		...
		printf("%lld\n", unionAreaRect(cnt));	// call this function to compute the area
	}
	return 0;
}