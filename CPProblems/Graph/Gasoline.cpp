/*
http://codeforces.com/gym/101908/problem/G
Binary search the answer, for each mid value (t) in binary search build the graph only with the edged that has
time less than or equal to t and compute the max flow to check if it's possible. Becareful with the implementation
of the max flow algorithm need to be efficient, I used this:
